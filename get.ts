 ...
 * it was sometimes troublesome to access deeply-nested properties in huge JavaScript 
 * objects when some of the intermediate properties might not be present.
 */
/**
