 ...
 * Implement the curry function which accepts a function as the only argument and 
 * returns a function that accepts single arguments and can be repeatedly called until at 
 * least the minimum number of arguments have been provided (determined by how many arguments 
